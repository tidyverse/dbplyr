...
- Use
  [`memdb_frame()`](https://dbplyr.tidyverse.org/reference/memdb.md)/[`tbl_memdb()`](https://dbplyr.tidyverse.org/reference/src_memdb.md)
  to easily create datasets that live in an in-memory SQLite database.

- Use
  [`lazy_frame()`](https://dbplyr.tidyverse.org/reference/tbl_lazy.md)/[`tbl_lazy()`](https://dbplyr.tidyverse.org/reference/tbl_lazy.md)
...
[`lazy_frame()`](https://dbplyr.tidyverse.org/reference/tbl_lazy.md) and
[`tbl_lazy()`](https://dbplyr.tidyverse.org/reference/tbl_lazy.md). Both
take an `con` argument which takes a database “simulator” like
