...
- `quote_identifier`: A function that quotes identifiers. This will
  ...
  [`sql_quote()`](https://dbplyr.tidyverse.org/reference/sql_quote.md)
  or to
...
[`sql_glue2()`](https://dbplyr.tidyverse.org/reference/sql_glue.md). It
uses glue syntax with type markers for safe SQL generation:
...
[`summarise()`](https://dplyr.tidyverse.org/reference/summarise.html)
all use
[`lazy_select_query()`](https://dbplyr.tidyverse.org/reference/sql_build.md),
whereas
[`left_join()`](https://dplyr.tidyverse.org/reference/mutate-joins.html)
and
[`inner_join()`](https://dplyr.tidyverse.org/reference/mutate-joins.html)
...
First,
[`sql_build()`](https://dbplyr.tidyverse.org/reference/sql_build.md)
recurses over the lazy query, building up query objects like
[`select_query()`](https://dbplyr.tidyverse.org/reference/sql_build.md)
...
Next,
[`sql_render()`](https://dbplyr.tidyverse.org/reference/sql_build.md) is
called on the result of
[`sql_build()`](https://dbplyr.tidyverse.org/reference/sql_build.md) and
dispatches to generics like
[`sql_query_select()`](https://dbplyr.tidyverse.org/reference/db-sql.md),
[`sql_query_join()`](https://dbplyr.tidyverse.org/reference/db-sql.md),
[`sql_query_semi_join()`](https://dbplyr.tidyverse.org/reference/db-sql.md),
and
...
[`sql_glue()`](https://dbplyr.tidyverse.org/reference/sql_glue.md). This
uses glue syntax for string interpolation with automatic escaping.
