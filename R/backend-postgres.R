#' @export
sql_clause_sample.PostgreSQLConnection <- function(sample, con) {
...
#' @export
sql_clause_sample.PostgreSQL <- sql_clause_sample.PostgreSQLConnection

#' @export
sql_clause_sample.PqConnection <- sql_clause_sample.PostgreSQLConnection
