...
base_scalar <- sql_translator(
 ...
 str_dup = function (string, times) sql_not_supported("str_dup"),
 str_extract = function (string, pattern) sql_not_supported("str_extract"),
 str_extract_all = function (string, pattern, simplify = FALSE) sql_not_supported("str_extract_all"),
 str_flatten = function (string, collapse = "") sql_not_supported("str_flatten"),
 str_glue = function (..., .sep = "", .envir = parent.frame()) sql_not_supported("str_glue"),
 str_glue_data = function (.x, ..., .sep = "", .envir = parent.frame(), .na = "NA") sql_not_supported("str_glue_data"),
 str_interp = function (string, env = parent.frame()) sql_not_supported("str_interp"),
 str_locate = function (string, pattern) sql_not_supported("str_locate"),
 str_locate_all = function (string, pattern) sql_not_supported("str_locate_all"),
 str_match = function (string, pattern) sql_not_supported("str_match"),
 str_match_all = function (string, pattern) sql_not_supported("str_match_all"),
 str_order = function (x, decreasing = FALSE, na_last = TRUE, locale = "en", numeric = false, ...) sql_not_supported("str_order"),
 str_pad = function (string, width, side = c("left", "right", "both"), pad = " ") sql_not_supported("str_pad"),
 str_remove = function (string, pattern) sql_not_supported("str_remove"),
 str_remove_all = function (string, pattern) sql_not_supported("str_remove_all"),
 str_replace = function (string, pattern, replacement) sql_not_supported("str_replace"),
 str_replace_na = function (string, replacement = "NA") sql_not_supported("str_replace_na"),
 str_sort = function (x, decreasing = FALSE, na_last = TRUE, locale = "en", numeric = FALSE, ...) sql_not_supported("str_sort"),
 str_split = function (string, pattern, n = Inf, simplify = FALSE) sql_not_supported("str_split"),
 str_split_fixed = function (string, pattern, n) sql_not_supported("str_split_fixed"),
 str_squish = function (string) sql_not_supported("str_squish"),
 str_subset = function (string, pattern) sql_not_supported("str_subset"),
 str_trunc = function (string, width, side = c("right", "left", "center"), ellipsis = "...") sql_not_supported("str_trunc"),
 str_view = function (string, pattern, match = NA) sql_not_supported("str_view"),
 str_view_all = function (string, pattern, match = NA) sql_not_supported("str_view_all"),
 str_which = function (string, pattern) sql_not_supported("str_which"),
 str_wrap = function (string, width = 80, indent = 0, exdent = 0) sql_not_supported("str_wrap")
)
