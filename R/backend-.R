...
base_scalar <- sql_translator(
  ...
  `%--%` = sql_not_supported("%--%()"),
  add_with_rollback = sql_not_supported("add_with_rollback()"),
  am = sql_not_supported("am()"),
  ceiling_date = sql_not_supported("ceiling_date()"),
  date = sql_not_supported("date()"),
  date_decimal = sql_not_supported("date_decimal()"),
  days = sql_not_supported("days()"),
  days_in_month = sql_not_supported("days_in_month()"),
  ddays = sql_not_supported("ddays()"),
  decimal_date = sql_not_supported("decimal_date()"),
  dhours = sql_not_supported("dhours()"),
  dmicroseconds = sql_not_supported("dmicroseconds()"),
  dmilliseconds = sql_not_supported("dmilliseconds()"),
  dminutes = sql_not_supported("dminutes()"),
  dmy = sql_not_supported("dmy()"),
  dmy_h = sql_not_supported("dmy_h()"),
  dmy_hm = sql_not_supported("dmy_hm()"),
  dmy_hms = sql_not_supported("dmy_hms()"),
  dnanoseconds = sql_not_supported("dnanoseconds()"),
  dpicoseconds = sql_not_supported("dpicoseconds()"),
  dseconds = sql_not_supported("dseconds()"),
  dst = sql_not_supported("dst()"),
  duration = sql_not_supported("duration()"),
  dweeks = sql_not_supported("dweeks()"),
  dyears = sql_not_supported("dyears()"),
  dym = sql_not_supported("dym()"),
  edays = sql_not_supported("edays()"),
  ehours = sql_not_supported("ehours()"),
  emicroseconds = sql_not_supported("emicroseconds()"),
  emilliseconds = sql_not_supported("emilliseconds()"),
  eminutes = sql_not_supported("eminutes()"),
  enanoseconds = sql_not_supported("enanoseconds()"),
  epicoseconds = sql_not_supported("epicoseconds()"),
  epiweek = sql_not_supported("epiweek()"),
  epiyear = sql_not_supported("epiyear()"),
  eseconds = sql_not_supported("eseconds()"),
  eweeks = sql_not_supported("eweeks()"),
  eyears = sql_not_supported("eyears()"),
  fast_strptime = sql_not_supported("fast_strptime()"),
  fit_to_timeline = sql_not_supported("fit_to_timeline()"),
  floor_date = sql_not_supported("floor_date()"),
  force_tz = sql_not_supported("force_tz()"),
  force_tzs = sql_not_supported("force_tzs()"),
  guess_formats = sql_not_supported("guess_formats()"),
  here = sql_not_supported("here()"),
  hm = sql_not_supported("hm()"),
  hms = sql_not_supported("hms()"),
  hours = sql_not_supported("hours()"),
  int_aligns = sql_not_supported("int_aligns()"),
  int_diff = sql_not_supported("int_diff()"),
  int_end = sql_not_supported("int_end()"),
  int_flip = sql_not_supported("int_flip()"),
  int_length = sql_not_supported("int_length()"),
  int_overlaps = sql_not_supported("int_overlaps()"),
  int_shift = sql_not_supported("int_shift()"),
  int_standardize = sql_not_supported("int_standardize()"),
  int_start = sql_not_supported("int_start()"),
  intersect = sql_not_supported("intersect()"),
  interval = sql_not_supported("interval()"),
  is.Date = sql_not_supported("is.Date()"),
  is.difftime = sql_not_supported("is.difftime()"),
  is.duration = sql_not_supported("is.duration()"),
  is.instant = sql_not_supported("is.instant()"),
  is.interval = sql_not_supported("is.interval()"),
  is.period = sql_not_supported("is.period()"),
  is.POSIXct = sql_not_supported("is.POSIXct()"),
  is.POSIXlt = sql_not_supported("is.POSIXlt()"),
  is.POSIXt = sql_not_supported("is.POSIXt()"),
  is.timepoint = sql_not_supported("is.timepoint()"),
  is.timespan = sql_not_supported("is.timespan()"),
  isoweek = sql_not_supported("isoweek()"),
  isoyear = sql_not_supported("isoyear()"),
  leap_year = sql_not_supported("leap_year()"),
  local_time = sql_not_supported("local_time()"),
  make_date = sql_not_supported("make_date()"),
  make_datetime = sql_not_supported("make_datetime()"),
  make_difftime = sql_not_supported("make_difftime()"),
  mday = sql_not_supported("mday()"),
  mdy = sql_not_supported("mdy()"),
  mdy_h = sql_not_supported("mdy_h()"),
  mdy_hm = sql_not_supported("mdy_hm()"),
  mdy_hms = sql_not_supported("mdy_hms()"),
  microseconds = sql_not_supported("microseconds()"),
  milliseconds = sql_not_supported("milliseconds()"),
  minutes = sql_not_supported("minutes()"),
  ms = sql_not_supported("ms()"),
  myd = sql_not_supported("myd()"),
  nanoseconds = sql_not_supported("nanoseconds()"),
  new_difftime = sql_not_supported("new_difftime()"),
  new_duration = sql_not_supported("new_duration()"),
  new_interval = sql_not_supported("new_interval()"),
  new_period = sql_not_supported("new_period()"),
  olson_time_zones = sql_not_supported("olson_time_zones()"),
  parse_date_time = sql_not_supported("parse_date_time()"),
  parse_date_time2 = sql_not_supported("parse_date_time2()"),
  period = sql_not_supported("period()"),
  period_to_seconds = sql_not_supported("period_to_seconds()"),
  picoseconds = sql_not_supported("picoseconds()"),
  pm = sql_not_supported("pm()"),
  pretty_dates = sql_not_supported("pretty_dates()"),
  qday = sql_not_supported("qday()"),
  quarter = sql_not_supported("quarter()"),
  reclass_date = sql_not_supported("reclass_date()"),
  rollback = sql_not_supported("rollback()"),
  round_date = sql_not_supported("round_date()"),
  seconds = sql_not_supported("seconds()"),
  seconds_to_period = sql_not_supported("seconds_to_period()"),
  semester = sql_not_supported("semester()"),
  setdiff = sql_not_supported("setdiff()"),
  stamp = sql_not_supported("stamp()"),
  stamp_date = sql_not_supported("stamp_date()"),
  stamp_time = sql_not_supported("stamp_time()"),
  tz = sql_not_supported("tz()"),
  union = sql_not_supported("union()"),
  wday = sql_not_supported("wday()"),
  week = sql_not_supported("week()"),
  weeks = sql_not_supported("weeks()"),
  with_tz = sql_not_supported("with_tz()"),
  yday = sql_not_supported("yday()"),
  ydm = sql_not_supported("ydm()"),
  ydm_h = sql_not_supported("ydm_h()"),
  ydm_hm = sql_not_supported("ydm_hm()"),
  ydm_hms = sql_not_supported("ydm_hms()"),
  years = sql_not_supported("years()"),
  ymd = sql_not_supported("ymd()"),
  ymd_h = sql_not_supported("ymd_h()"),
  ymd_hm = sql_not_supported("ymd_hm()"),
  ymd_hms = sql_not_supported("ymd_hms()"),
  yq = sql_not_supported("yq()")
)
