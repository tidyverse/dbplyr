...
- [`dialect_ansi()`](https://dbplyr.tidyverse.org/dev/reference/backend-ansi.md)
...
- [`dialect_access()`](https://dbplyr.tidyverse.org/dev/reference/backend-access.md)
  ...
  : MS Access backend
- [`backend-adbc`](https://dbplyr.tidyverse.org/dev/reference/backend-adbc.md)
  : ADBC backend
...
- [`dialect_odbc()`](https://dbplyr.tidyverse.org/dev/reference/backend-odbc.md)
