...
This outlines how to propose a change to dbplyr. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("batpigandme/dbplyr", fork = TRUE)`.
...
of Conduct](https://dbplyr.tidyverse.org/dev/CODE_OF_CONDUCT.md). By
