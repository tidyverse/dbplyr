...
test_that("custom lubridate functions translated correctly", {
  ...
  expect_equal(trans(seconds(x)),                   sql("CAST('`x` seconds' AS INTERVAL)"))
  expect_equal(trans(minutes(x)),                   sql("CAST('`x` minutes' AS INTERVAL)"))
  expect_equal(trans(hours(x)),                     sql("CAST('`x` hours' AS INTERVAL)"))
  expect_equal(trans(days(x)),                      sql("CAST('`x` days' AS INTERVAL)"))
  expect_equal(trans(weeks(x)),                     sql("CAST('`x` weeks' AS INTERVAL)"))
  expect_equal(trans(months(x)),                    sql("CAST('`x` months' AS INTERVAL)"))
