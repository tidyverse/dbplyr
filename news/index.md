...
- Newly deprecated:
  ...
  - [`as.sql()`](https://dbplyr.tidyverse.org/reference/as.sql.md), as
    part of major internal refactoring of how
    [`sql()`](https://dbplyr.tidyverse.org/reference/sql.md) and
    [`ident()`](https://dbplyr.tidyverse.org/reference/ident.md) are
  ...
  - The `cte` argument of
    ...
    and
    [`show_query()`](https://dbplyr.tidyverse.org/reference/show_query.md);
  ...
  - [`escape_ansi()`](https://dbplyr.tidyverse.org/reference/escape_ansi.md).
  ...
  - [`src_memdb()`](https://dbplyr.tidyverse.org/reference/src_memdb.md)
    and
    [`tbl_memdb()`](https://dbplyr.tidyverse.org/reference/src_memdb.md);
    use [`memdb()`](https://dbplyr.tidyverse.org/reference/memdb.md) and
    `copy_to(memdb(), df)` instead. There’s also a new
...
- Previously-defunct functions have been removed:
  ...
  - `partial_eval(var)`, deprecated in 2.2.0 (2022-06-05)
    ([\#1632](https://github.com/tidyverse/dbplyr/issues/1632)).
  - [`src_sql()`](https://dbplyr.tidyverse.org/reference/src_sql.md),
...
- [`build_sql()`](https://dbplyr.tidyverse.org/reference/build_sql.md),
  [`sql_expr()`](https://dbplyr.tidyverse.org/reference/sql_expr.md),
  and
  [`sql_call2()`](https://dbplyr.tidyverse.org/reference/sql_expr.md)
  are superseded in favour of
  [`sql_glue()`](https://dbplyr.tidyverse.org/reference/sql_glue.md) and
...
- [`remote_table()`](https://dbplyr.tidyverse.org/reference/remote_name.md)
  returns an [`sql()`](https://dbplyr.tidyverse.org/reference/sql.md)
  object containing the (correctly quoted) table identifier, rather than
  the internal `dbplyr_table_path`. This makes the result suitable for
  inlining into
  [`build_sql()`](https://dbplyr.tidyverse.org/reference/build_sql.md)
  and
  [`sql_glue2()`](https://dbplyr.tidyverse.org/reference/sql_glue.md)
...
- [`set_op_query()`](https://dbplyr.tidyverse.org/reference/sql_build.md)
...
- [`sql_optimise()`](https://dbplyr.tidyverse.org/reference/sql_optimise.md)
...
- Specification of table names with schema/catalogs has been overhauled
  ...
  - Use of [`sql()`](https://dbplyr.tidyverse.org/reference/sql.md) and
    [`ident_q()`](https://dbplyr.tidyverse.org/reference/ident_q.md)
    inside
    [`in_catalog()`](https://dbplyr.tidyverse.org/reference/in_schema.md)
    and
    [`in_schema()`](https://dbplyr.tidyverse.org/reference/in_schema.md)
...
- Deprecation status of functions deprecated in previous versions (at
  ...
  [`src_sql()`](https://dbplyr.tidyverse.org/reference/src_sql.md) is
  now defunct, as is the use of
  [`partial_eval()`](https://dbplyr.tidyverse.org/reference/partial_eval.md)
  with character `data`.
...
- [`compute()`](https://dplyr.tidyverse.org/reference/compute.html)
  ...
  [`sql_query_save()`](https://dbplyr.tidyverse.org/reference/db-sql.md)-methods
...
- [`tbl_lazy()`](https://dbplyr.tidyverse.org/reference/tbl_lazy.md)
...
- [`db_copy_to()`](https://dbplyr.tidyverse.org/reference/db-io.md)’s
  `...` are now passed to
...
- [`sql_random()`](https://dbplyr.tidyverse.org/reference/db-sql.md) is
  now deprecated. It was used to power
  [`slice_sample()`](https://dplyr.tidyverse.org/reference/slice.html)
...
- [`tbl()`](https://dplyr.tidyverse.org/reference/tbl.html) now informs
  ...
  [`in_schema()`](https://dbplyr.tidyverse.org/reference/in_schema.md)
  or [`sql()`](https://dbplyr.tidyverse.org/reference/sql.md)
  ([@mgirlich](https://github.com/mgirlich),
...
- [`sql()`](https://dbplyr.tidyverse.org/reference/sql.md) now evaluates
  its arguments locally also when used in
  [`across()`](https://dplyr.tidyverse.org/reference/across.html)
  ([@mgirlich](https://github.com/mgirlich),
...
- [`sql()`](https://dbplyr.tidyverse.org/reference/sql.md) is now
...
- [`in_schema()`](https://dbplyr.tidyverse.org/reference/in_schema.md)
  ...
  [`sql()`](https://dbplyr.tidyverse.org/reference/sql.md) to opt out of
  quoting, if needed). And
...
- A number of `db_*` generics have been replaced with new SQL generation
  ...
  - [`dplyr::db_analyze()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.html)
    -\>
    [`dbplyr::sql_table_analyze()`](https://dbplyr.tidyverse.org/reference/db-sql.md)
  - [`dplyr::db_create_index()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.html)
    -\>
    [`dbplyr::sql_table_index()`](https://dbplyr.tidyverse.org/reference/db-sql.md)
  ...
  - [`dplyr::db_query_fields()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.html)
    -\>
    [`dbplyr::sql_query_fields()`](https://dbplyr.tidyverse.org/reference/db-sql.md)
  - [`dplyr::db_save_query()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.html)
    -\>
    [`dbplyr::sql_query_save()`](https://dbplyr.tidyverse.org/reference/db-sql.md)
...
- A number of other generics have been renamed to facilitate the move
  ...
  - [`dplyr::sql_select()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.html)
    -\>
    [`dbplyr::sql_query_select()`](https://dbplyr.tidyverse.org/reference/db-sql.md)
  - [`dplyr::sql_join()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.html)
    -\>
    [`dbplyr::sql_query_join()`](https://dbplyr.tidyverse.org/reference/db-sql.md)
  - [`dplyr::sql_semi_join()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.html)
    -\>
    [`dbplyr::sql_query_semi_join()`](https://dbplyr.tidyverse.org/reference/db-sql.md)
  - [`dplyr::sql_set_op()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.html)
    -\>
    [`dbplyr::sql_query_set_op()`](https://dbplyr.tidyverse.org/reference/db-sql.md)
  - [`dplyr::sql_subquery()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.html)
    -\>
    [`dbplyr::sql_query_wrap()`](https://dbplyr.tidyverse.org/reference/db-sql.md)
  - [`dplyr::db_desc()`](https://dplyr.tidyverse.org/reference/backend_dbplyr.html)
    -\>
    [`dbplyr::db_connection_describe()`](https://dbplyr.tidyverse.org/reference/db-misc.md)
...
- [`copy_lahman()`](https://dbplyr.tidyverse.org/reference/lahman.md)
  and
  [`copy_nycflights13()`](https://dbplyr.tidyverse.org/reference/nycflights13.md)
  (and hence
  [`nycflights13_sqlite()`](https://dbplyr.tidyverse.org/reference/nycflights13.md))
  and friends now return DBI connections rather than the now deprecated
  [`src_dbi()`](https://dbplyr.tidyverse.org/reference/src_dbi.md)
...
- [`escape()`](https://dbplyr.tidyverse.org/reference/escape.md) now
...
- The Date and POSIXt methods for
  [`escape()`](https://dbplyr.tidyverse.org/reference/escape.md) now use
  exported
  [`sql_escape_date()`](https://dbplyr.tidyverse.org/reference/escape.md)
  and
...
- Overall, dplyr generates many fewer subqueries:
  ...
  - Joins and semi-joins no longer add an unneeded subquery
    ...
    [`sql_render()`](https://dbplyr.tidyverse.org/reference/sql_build.md);
...
- New
  [`vignette("reprex")`](https://dbplyr.tidyverse.org/articles/reprex.md)
...
- [`tbl_lazy()`](https://dbplyr.tidyverse.org/reference/tbl_lazy.md) now
  actually puts a
...
- [`escape()`](https://dbplyr.tidyverse.org/reference/escape.md),
  [`sql_expr()`](https://dbplyr.tidyverse.org/reference/sql_expr.md) and
  [`build_sql()`](https://dbplyr.tidyverse.org/reference/build_sql.md)
...
- New
  ...
  [`sql_expr()`](https://dbplyr.tidyverse.org/reference/sql_expr.md) is
  to [`rlang::expr()`](https://rlang.r-lib.org/reference/expr.html).
...
- `vars` argument to
  [`tbl_sql()`](https://dbplyr.tidyverse.org/reference/tbl_sql.md) has
  been formally deprecated; it hasn’t actually done anything for a while
  ([\#3254](https://github.com/tidyverse/dbplyr/issues/3254)).
...
- New [`sql_expr()`](https://dbplyr.tidyverse.org/reference/sql_expr.md)
...
- New
  ...
  [`win_recycled()`](https://dbplyr.tidyverse.org/reference/sql_translation_window.md)
  is equivalent to
  [`win_aggregate()`](https://dbplyr.tidyverse.org/reference/sql_translation_window.md)
...
- [`ident()`](https://dbplyr.tidyverse.org/reference/ident.md) and
  [`ident_q()`](https://dbplyr.tidyverse.org/reference/ident_q.md)
...
- [`tbl_lazy()`](https://dbplyr.tidyverse.org/reference/tbl_lazy.md) and
  `lazy_tbl()` have been exported. These help you test generated SQL
...
- New [`as.sql()`](https://dbplyr.tidyverse.org/reference/as.sql.md)
...
- New [`ident_q()`](https://dbplyr.tidyverse.org/reference/ident_q.md)
...
- [`ident()`](https://dbplyr.tidyverse.org/reference/ident.md) now
...
- New [`db_copy_to()`](https://dbplyr.tidyverse.org/reference/db-io.md),
  [`db_compute()`](https://dbplyr.tidyverse.org/reference/db-io.md) and
...
- \[API\]
  [`op_vars()`](https://dbplyr.tidyverse.org/reference/lazy_ops.md) now
  returns a list of quoted expressions. This enables escaping to happen
  at the correct time (i.e. when the connection is known).
