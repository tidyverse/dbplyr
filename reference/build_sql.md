...
- ...:
  ...
  [`sql()`](https://dbplyr.tidyverse.org/reference/sql.md) to preserve
  user input as is (dangerous), and
  [`ident()`](https://dbplyr.tidyverse.org/reference/ident.md) to label
  user input as sql identifiers (safe)
