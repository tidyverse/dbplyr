...
- con:
  ...
  A [sql_dialect](https://dbplyr.tidyverse.org/reference/sql_dialect.md)
...
[`sql_translation_agg`](https://dbplyr.tidyverse.org/reference/sql_translation_agg.md),
[`sql_translation_scalar`](https://dbplyr.tidyverse.org/reference/sql_translation_scalar.md),
[`sql_translation_string`](https://dbplyr.tidyverse.org/reference/sql_translation_string.md),
