...
Learn more in
[`vignette("dbplyr")`](https://dbplyr.tidyverse.org/articles/dbplyr.md).
...
- from:
  ...
  [`sql()`](https://dbplyr.tidyverse.org/reference/sql.md) string.
  ...
  [`in_schema()`](https://dbplyr.tidyverse.org/reference/in_schema.md)/[`in_catalog()`](https://dbplyr.tidyverse.org/reference/in_schema.md)
