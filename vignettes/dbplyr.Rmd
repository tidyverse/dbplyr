...
This might not be exactly what you'd write by hand, but it's probably pretty close.
...
If you already know SQL, why use dbplyr? One nicety it will automatically generate subqueries if you want to use a freshly created variable in `mutate()`:
