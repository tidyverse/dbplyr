...
-   dbplyr 2.1.0 (to be released \>= 6 months after dplyr 2.0.0) deprecates the old interface, so that users are encouraged to upgrade backends.

-   dbplyr 2.2.0 (to be released \>= 12 months after dplyr 2.0.0) removes the old interface so user must upgrade backends.
