...
#| eval: false
# Create an index
glue_sql2(con, "CREATE INDEX {.id index_name} ON {.tbl table} {.id columns*}")
...
Type markers include `.tbl` (tables), `.id` (identifiers).. Use `*` after `.id` or `.val` to collapse vectors into comma-separated lists.
