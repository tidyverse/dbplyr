...
This document is still a work in progress, but it will hopefully get you started. I'd also strongly recommending the bundled source code for [SQLite](https://github.com/hadley/dbplyr/blob/master/R/db-sqlite.r), [MySQL](https://github.com/hadley/dbplyr/blob/master/R/db-mysql.r), and [PostgreSQL](https://github.com/hadley/dbplyr/blob/master/R/db-postgres.r).

## First steps

For interactive exploation, attach dplyr, dbplyr and DBI. If you're creating a package, you'll need to import these packages.
...
Now is a good time to implement a method for `src_desc()`. This should briefly describe the connection, typically formatting the information returned form `dbGetInfo()`. This is what dbplyr does for Postgres connections:
