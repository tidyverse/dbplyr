...
Type markers include `.tbl` (tables), `.col` (columns), `.val` (values), `.name` (names), `.from` (subqueries/tables), and `.kw` (keywords). Use `*` after `.col` or `.val` to collapse vectors into comma-separated lists.
